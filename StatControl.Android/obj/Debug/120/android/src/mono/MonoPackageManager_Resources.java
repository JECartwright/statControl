...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "StatControl.Android.dll" comes first in this list. */
		"StatControl.Android.dll",
		"ExpressionParserZero.dll",
		"FormsViewGroup.dll",
		"FunctionZero.CommandZero.dll",
		"FunctionZero.MvvmZero.dll",
		"FunctionZero.zBind.dll",
		"Newtonsoft.Json.dll",
		"SimpleInjector.dll",
		"StatControl.dll",
